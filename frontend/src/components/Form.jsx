    ...
    <Navbar/>
      <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Fill in the details</h2>
        </div>
        <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div>
              <label htmlFor="ctype" className="block text-sm font-semibold leading-6 text-gray-900">
                Company Type
              </label>
              <div className="mt-2.5">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="cloc" className="block text-sm font-semibold leading-6 text-gray-900">
                Location
              </label>
              <div className="mt-2.5">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="target" className="block text-sm font-semibold leading-6 text-gray-900">
                Target Customers
              </label>
              <div className="mt-2.5">
                <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="scale" className="block text-sm font-semibold leading-6 text-gray-900">
                Company Scale
              </label>
              <div className="mt-2.5">
                <select
